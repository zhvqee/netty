...
public abstract class AbstractChannel extends DefaultAttributeMap implements Channel {
    ...
    /**
     * 每个channel 对应一个eventLOOP 线程，通过该线程来轮询channel
     */
    ...
    protected abstract class AbstractUnsafe implements Unsafe {
        ...
        /**
         * register 是把 Channel 注册到EventLoop 上
         * <p>
         * 1、比如这个Channel 是 listenfd channel ，则是在boss Thread 线程执行，所以eventLoop.inEventLoop() 是true的，
         * 2、如果这个channel 是 客户端对应的 clientFd, 则是在acceptor boss线程返回的接收，此时线程还是boss 线程，
         * 然后通过chooser 选择一个EventLoop， 此时 执行的是boss 线程不在EventLoop 上，所以需要进行这样的判断
         *
         * @param eventLoop
         * @param promise
         */
        ...
        public final void register(EventLoop eventLoop, final ChannelPromise promise) {
            ...
            if (eventLoop.inEventLoop()) { // 注册 listenFd channel
                register0(promise);
            } else {
                try {
                    eventLoop.execute(new Runnable() {
                        @Override
                        public void run() {
                            register0(promise); // 客户端channel clientFd
                        }
                    });
                } catch (Throwable t) {
                    logger.warn(
